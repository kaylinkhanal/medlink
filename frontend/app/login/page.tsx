      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .left-panel::before {
          ...
          inset: 0;
          background:
            radial-gradient(ellipse 80% 60% at 20% 80%, rgba(6, 182, 212, 0.15) 0%, transparent 60%),
        ...
        <div className="left-panel">
          ...
          <div className="left-content">
            <h2 className="left-headline">
              Healthcare,<br /><em>reimagined</em><br />for everyone.
            </h2>
            <p className="left-sub">
              Access your medical records, appointments, and care team — all in one secure place.
            </p>
          </div>
        ...
        <div className="right-panel">
          <div className="form-container">
            <div className="form-header">
              ...
              <p className="form-subtitle">Sign in to your healthcare dashboard</p>
            </div>
            ...
            <div className="divider">
              ...
              <span className="divider-text">New to MedLink?</span>
              <div className="divider-line" />
            </div>
